...
class ChefState(TypedDict):
    messages: Annotated[List[str], add]         # 메시지
    execution_path: Annotated[List[str], add]   # 방문 기록
    scores: Annotated[List[int], add]           # 성과점수
    errors: Annotated[List[str], add]           # 에러 발생시 처리
